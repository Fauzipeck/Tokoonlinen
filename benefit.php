    ...
    <div class="container">
      ...
      <div class="benefit-content">
        <div class="benefit-content-wrapper">
          <div class="wrapper-left-up">
            <div class="benefit-line-bold"></div>
            <div class="benefit-content-line"></div>
          </div>
          <div class="wrapper-right">
            <i class="fa-solid fa-wallet"></i>
            <h4>Gratis Ongkir</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. A, ratione sunt. Dolorum reprehenderit autem sit!</p>
          </div>
        </div>
        <div class="benefit-content-wrapper">
